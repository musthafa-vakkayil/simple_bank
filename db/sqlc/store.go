...
// TransferTxParams contains the input paramets of the transfer transaction
type TransferTxParams struct {
	FromAccountID int64 `json:"from_account_id"`
	ToAccountID   int64 `josn:"to_account_id"`
...
func addMoney(ctx context.Context, q *Queries, firstId int64, amount1 int64, secondId int64, amount2 int64) (account1 Account, account2 Account, err error) {
